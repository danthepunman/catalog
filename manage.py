...
from app.models import Categories, Users, Items, FavoritesCategories, CategoryNodes, AmazonSearches, Comments
...
def make_shell_context():
    return dict(app=app, db=db, Categories=Categories, Users=Users, Items=Items, Comments=Comments,
                FavoritesCategories=FavoritesCategories, CategoriesNode=CategoryNodes, AmazonSearch=AmazonSearches,
